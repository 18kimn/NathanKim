...
```{r}
if(params$pdf_mode){
  cat("View this CV online with links at _nathankim.name/cv/_")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/18kimn/nathankim/raw/master/content/cv/cv.pdf)")
}
```
